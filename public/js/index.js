...
function setupAboutSection() {
  ...
  if (aboutVersion) {
    aboutWords.push(...aboutVersion.querySelectorAll('.word'));
  }
...
function setupProjectsSection() {
        ...
        for (var y = 0; y < rows; y++) {
          for (var x = 0; x < cols; x++) {
            ...
            if (hitTime[y][x] > 0 && elapsed < cellDuration[y][x]) {
              ...
              html += '<span style="color:#0a0a0a;background:#8a8a8a">' + esc(ch) + '</span>';
            } else {
  ...
  const PROJECTS = {
    'pricera': {
      desc: isEn ? "Pricera is an AI-powered smart shopping platform built to help users make better purchasing decisions with confidence. It enables instant price comparison across major retailers, tracks historical pricing trends, and uses intelligent recommendations to identify the best time to buy.\n\nDesigned with a premium SaaS-inspired user experience, the project combines modern web development with practical AI-driven functionality to solve a real consumer problem—making online shopping smarter, faster, and more transparent." : "Pricera is an AI-powered smart shopping platform built to help users make better purchasing decisions with confidence. It enables instant price comparison across major retailers, tracks historical pricing trends, and uses intelligent recommendations to identify the best time to buy.\n\nDesigned with a premium SaaS-inspired user experience, the project combines modern web development with practical AI-driven functionality to solve a real consumer problem—making online shopping smarter, faster, and more transparent.",
      category: 'AI / SaaS', year: '2026', tags: ['React', 'AI', 'SaaS'],
      images: ['assets/images/projects/Covers/Pricera.png'],
    },
    'aniquahportfolio': {
      desc: isEn ? "Designed and developed a premium personal portfolio website for a client, focused on creating an elegant digital identity that reflects personality, professionalism, and individuality. The design combines refined typography, minimal aesthetics, and subtle interactive animations to deliver a sophisticated user experience.\n\nBuilt with a strong emphasis on responsiveness, smooth navigation, and visual storytelling, the portfolio effectively showcases the client’s background, skills, journey, and experience while maintaining a clean, modern, and memorable online presence." : "Designed and developed a premium personal portfolio website for a client, focused on creating an elegant digital identity that reflects personality, professionalism, and individuality. The design combines refined typography, minimal aesthetics, and subtle interactive animations to deliver a sophisticated user experience.\n\nBuilt with a strong emphasis on responsiveness, smooth navigation, and visual storytelling, the portfolio effectively showcases the client’s background, skills, journey, and experience while maintaining a clean, modern, and memorable online presence.",
      category: 'Portfolio', year: '2026', tags: ['React', 'Animation', 'Tailwind'],
      images: ['assets/images/projects/Covers/AniquahPortfolio.png'],
    },
    'calcuttafitness': {
      desc: isEn ? "Designed and developed a high-conversion premium website for The Calcutta Fitness, focused on building a bold digital presence for a modern fitness brand. The project emphasizes strong visual hierarchy, impactful typography, conversion-driven call-to-actions, and an immersive user experience that reflects the energy and intensity of the fitness industry.\n\nBuilt with a modern responsive architecture, the platform showcases memberships, programs, locations, and brand credibility through sleek UI design, smooth interactions, and performance-focused development—creating a powerful online experience designed to drive engagement and member acquisition." : "Designed and developed a high-conversion premium website for The Calcutta Fitness, focused on building a bold digital presence for a modern fitness brand. The project emphasizes strong visual hierarchy, impactful typography, conversion-driven call-to-actions, and an immersive user experience that reflects the energy and intensity of the fitness industry.\n\nBuilt with a modern responsive architecture, the platform showcases memberships, programs, locations, and brand credibility through sleek UI design, smooth interactions, and performance-focused development—creating a powerful online experience designed to drive engagement and member acquisition.",
      category: 'Fitness Brand', year: '2026', tags: ['Next.js', 'Tailwind', 'Framer Motion'],
      images: ['assets/images/projects/Covers/CalcuttaFitness.png'],
    },
    'landsafe': {
      desc: isEn ? "LandSafe is an AI-powered property verification platform designed to help buyers make safer real estate decisions by detecting fraud, verifying ownership records, and uncovering hidden legal or financial risks before purchase. The platform transforms complex property due diligence into a fast, accessible, and confidence-driven digital experience.\n\nDesigned with a premium SaaS-style interface and modern product-first approach, the project combines intelligent risk analysis, clean UX, and scalable web architecture to solve a real high-impact problem in the real estate ecosystem." : "LandSafe is an AI-powered property verification platform designed to help buyers make safer real estate decisions by detecting fraud, verifying ownership records, and uncovering hidden legal or financial risks before purchase. The platform transforms complex property due diligence into a fast, accessible, and confidence-driven digital experience.\n\nDesigned with a premium SaaS-style interface and modern product-first approach, the project combines intelligent risk analysis, clean UX, and scalable web architecture to solve a real high-impact problem in the real estate ecosystem.",
      category: 'AI / SaaS', year: '2026', tags: ['React', 'AI', 'Supabase'],
      images: ['assets/images/projects/Covers/LandSafe.png'],
    },
    'pypredict': {
      desc: isEn ? "Machine learning prediction tool visualizing model training progress, regression curves, and regression forecasts." : "Machine learning prediction tool visualizing model training progress, regression curves, and regression forecasts.",
      category: 'AI / ML', year: '2026', tags: ['Python', 'Scikit-Learn', 'ML'],
      images: ['assets/images/projects/Covers/PyPredict.png'],
    },
    'bizmetrics': {
      desc: isEn ? "Business KPI tracker measuring revenue growth, operations progress, and financial metrics in real-time." : "Business KPI tracker measuring revenue growth, operations progress, and financial metrics in real-time.",
      category: 'Dashboard', year: '2025', tags: ['React', 'Excel', 'Data Analysis'],
      images: ['assets/images/projects/Covers/BizMetrics.png'],
    },
    'queryvault': {
      desc: isEn ? "Visual SQL database explorer and schema query builder enabling visual representation of table relationships." : "Visual SQL database explorer and schema query builder enabling visual representation of table relationships.",
      category: 'Tools', year: '2025', tags: ['SQL', 'Express', 'Node.js'],
      images: ['assets/images/projects/Covers/QueryVault.png'],
    },
    'insightai': {
      desc: isEn ? "AI-powered data insights tool that generates automated business suggestions and anomaly detection alerts." : "AI-powered data insights tool that generates automated business suggestions and anomaly detection alerts.",
      category: 'AI / Web', year: '2025', tags: ['Next.js', 'OpenAI', 'Supabase'],
      images: ['assets/images/projects/Covers/InsightAI.png'],
    },
  };
...
function handleIndexPageShow(e) {
  ...
  if (isBfcacheRestore || hasReturnFlag) {
...
// Execute immediately to handle SPA router navigations
handleIndexPageShow(null);
