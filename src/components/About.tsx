        ...
        <div className="max-w-6xl mx-auto my-0 py-0">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
            ...
            <div className={`space-y-6 transition-all duration-1000 delay-400 ${isVisible ? "opacity-100 translate-x-0" : "opacity-0 translate-x-10"}`}>
              ...
              return <div key={skill.name} className="glass rounded-xl p-6 hover:scale-105 transition-transform duration-300">
                    ...
                    <div className="w-full bg-muted/30 rounded-full h-3 overflow-hidden">
                      <div className={`h-full rounded-full transition-all duration-1000 ease-out ${skill.color === "text-primary" ? "bg-primary neon-glow" : skill.color === "text-secondary" ? "bg-secondary neon-glow-violet" : "bg-accent neon-glow-gold"}`} style={{
